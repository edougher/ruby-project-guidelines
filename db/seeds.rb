...
# recipe_time = rand(20..80)

# recipe_1 = Recipe.create(category: "Chicken", name: Faker::Food.dish, region: Faker::Nation.nationality, ingredient_list: total_ingredient, instruction: Faker::Food.description, time: recipe_time)
# recipe_2 = Recipe.create(category: "Chicken", name: Faker::Food.dish, region: Faker::Nation.nationality, ingredient_list: total_ingredient, instruction: Faker::Food.description, time: recipe_time)
# recipe_3 = Recipe.create(category: "Beef", name: Faker::Food.dish, region: Faker::Nation.nationality, ingredient_list: total_ingredient, instruction: Faker::Food.description, time: recipe_time)
# recipe_4 = Recipe.create(category: "Beef", name: Faker::Food.dish, region: Faker::Nation.nationality, ingredient_list: total_ingredient, instruction: Faker::Food.description, time: recipe_time)
# recipe_5 = Recipe.create(category: "Seafood", name: Faker::Food.dish, region: Faker::Nation.nationality, ingredient_list: total_ingredient, instruction: Faker::Food.description, time: recipe_time)
# recipe_6 = Recipe.create(category: "Seafood", name: Faker::Food.dish, region: Faker::Nation.nationality, ingredient_list: total_ingredient, instruction: Faker::Food.description, time: recipe_time)
# recipe_7 = Recipe.create(category: "Vegan", name: Faker::Food.dish, region: Faker::Nation.nationality, ingredient_list: total_ingredient, instruction: Faker::Food.description, time: recipe_time)
# recipe_8 = Recipe.create(category: "Vegetarian", name: Faker::Food.dish, region: Faker::Nation.nationality, ingredient_list: total_ingredient, instruction: Faker::Food.description, time: recipe_time)
# recipe_9 = Recipe.create(category: "Vegan", name: Faker::Food.dish, region: Faker::Nation.nationality, ingredient_list: total_ingredient, instruction: Faker::Food.description, time: recipe_time)
# recipe_10 = Recipe.create(category: "Pork", name: Faker::Food.dish, region: Faker::Nation.nationality, ingredient_list: total_ingredient, instruction: Faker::Food.description, time: recipe_time)
